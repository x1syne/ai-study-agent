/**
 * Скрипт для обработки PDF статей профессора Остроуха
 * Извлекает текст из PDF и добавляет в RAG систему
 * 
 * Использование: node scripts/process-pdf-articles.js
 */
...
// Список PDF файлов для обработки (без дубликатов)
const PDF_FILES = [
...
async function main() {
  console.log('🔍 Начинаю обработку PDF статей профессора Остроуха...\n')
  ...
  console.log(`📄 Найдено файлов для обработки: ${PDF_FILES.length}`)
  ...
  console.log(`\n🎉 Готово! Теперь нужно:`)
  console.log(`   1. Импортировать PDF_ARTICLES в professor-knowledge.ts`)
  console.log(`   2. Добавить индексацию в функцию indexScientificArticles()`)
  console.log(`   3. Запустить индексацию: PUT /api/professor/knowledge`)
