...
export function ChatInterface({ messages, onSendMessage, onCharacterChange, onSessionChange, isLoading, topicContext, currentSessionId }: ChatInterfaceProps) {
  ...
  return (
    <div className="flex flex-col h-full practicum-card overflow-hidden">
      {/* Header */}
      <div className="flex-shrink-0 px-4 sm:px-6 py-4 border-b border-[var(--color-border)]">
      ...
      <form onSubmit={handleSubmit} className="flex-shrink-0 p-3 sm:p-4 border-t border-[var(--color-border)] bg-[var(--color-bg)]">
